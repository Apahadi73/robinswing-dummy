            ...
            <div className="quote-container">
              <blockquote>
                <p className="d-flex justify-content-center p-4">
                  ...
                  Together, we can do more than we can do alone. Our goal with
                  Robinswing is to catalyze voter turnout to affect real change.
                  There are many ways to support our mission. Contact us to find
                  out more about volunteer opportunities and ways that you can
                  get our message to your community".
                </p>
              </blockquote>
              <cite>
                <span>SHAE KOBERLE-SATT</span>
                <br />
